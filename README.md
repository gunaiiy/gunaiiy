...
- **Infrastructure & Security:** Managing secrets and service networking with HashiCorp Vault & Consul, plus API traffic through Gravitee Gateway.
- **Monitoring & Data:** Observability with Prometheus, Grafana, and the Elastic Stack (Elasticsearch, Logstash, Kibana), alongside PostgreSQL for storage.
